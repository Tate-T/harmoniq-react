...
const users = [
  {
    ...
    avatarUrl:
      'https://ftp.goit.study/img/harmoniq/users/6881563901add19ee16fcff2.webp',
    articlesAmount: 2,
    email: 'anastasia.oliinyk@example.com',
    password: 'ana123',
    login: false,
    favorites: [],
  },
  {
    ...
    articlesAmount: 9,
    email: 'nazar.tkachenko@example.com',
    password: 'naz789',
    login: false,
    favorites: [],
  },
  {
    ...
    articlesAmount: 6,
    email: 'yeva.bondarenko@example.com',
    password: 'eva456',
    login: false,
    favorites: [],
  },
  {
    ...
    articlesAmount: 14,
    email: 'dmytro.romanenko@example.com',
    password: 'dim789',
    login: false,
    favorites: [],
  },
  {
    ...
    articlesAmount: 10,
    email: 'oleksandra.bondarenko@example.com',
    password: 'ole555',
    login: false,
    favorites: [],
  },
  {
    ...
    articlesAmount: 11,
    email: 'oleksandr.shevchuk@example.com',
    password: 'sha321',
    login: false,
    favorites: [],
  },
  {
    ...
    name: 'Софія Мельник',
    avatarUrl:
      'https://ftp.goit.study/img/harmoniq/users/6881563901add19ee16fcff8.webp',
    articlesAmount: 5,
  ...
  },
  {
    ...
    articlesAmount: 6,
    email: 'vladyslav.polishchuk@example.com',
    password: 'vla852',
    login: false,
    favorites: [],
  },
  {
    ...
    articlesAmount: 8,
    email: 'ivan.kovalchuk@example.com',
    password: 'iva963',
    login: false,
    favorites: [],
  },
  {
    ...
    articlesAmount: 13,
    email: 'daryna.kovalchuk@example.com',
    password: 'dar741',
    login: false,
    favorites: [],
  },
  {
    ...
    articlesAmount: 9,
    email: 'polina.romanenko@example.com',
    password: 'pol357',
    login: false,
    favorites: [],
  },
  {
    ...
    avatarUrl:
      'https://ftp.goit.study/img/harmoniq/users/6881563901add19ee16fcffd.webp',
    articlesAmount: 2,
    email: 'sofiia.kovalchuk@example.com',
    password: 'sof852',
    login: false,
    favorites: [],
  },
  {
    _id: '6881563901add19ee16fcffe',
    name: 'Владислав Гриценко',
    avatarUrl:
      'https://ftp.goit.study/img/harmoniq/users/6881563901add19ee16fcffe.webp',
    articlesAmount: 13,
    email: 'vladyslav.hrytsenko@example.com',
    password: 'vla753',
    login: false,
    favorites: [],
  },
  {
    _id: '6881563901add19ee16fcfff',
    name: 'Дарина Шевченко',
    avatarUrl:
      'https://ftp.goit.study/img/harmoniq/users/6881563901add19ee16fcfff.webp',
    articlesAmount: 13,
    email: 'daryna.shevchenko@example.com',
    password: 'dar951',
    login: false,
    favorites: [],
  },
  {
    _id: '6881563901add19ee16fd000',
    name: 'Катерина Лисенко',
    avatarUrl:
      'https://ftp.goit.study/img/harmoniq/users/6881563901add19ee16fd000.webp',
    articlesAmount: 3,
 ...
 const App = () => {
  ...
  const userCreator = data => {
    ...
    setUsers(prev => [
      ...prev.users,
      {
        _id: (prev => prev.users.length + 1).toString().padStart(12, '0'),
        name: data[0],
        avatarUrl:
